               ...
               /*    ----------Banner---------- */
                ...
                <div className="lesson-container">
                 <div className='mylesson'>
                        <h2>Lesson Handouts</h2>
                 </div>
                 <div className='lesson-detailsContainer'>
                    <div>
                    <img src={lesson.content1Image && lesson.content1Image.url} alt="content 1" />
                    <a href={lesson && lesson.contentSubFile} target='blank'>{lesson && lesson.content1Name} Handouts</a>
                    </div>
                    <div>
                    <img src={lesson.content2Image && lesson.content2Image.url} alt="content 2" />
        
                    <a href={lesson && lesson.contentSubFile2} target='blank'>{lesson && lesson.content2Name} Handouts</a>
                    </div>
                    <div>
                    <img src={lesson.content3Image && lesson.content3Image.url} alt="content 3" />
        
                    <a href={lesson && lesson.contentSubFile3} target='blank'>{lesson && lesson.content3Name} Handouts</a>
                    </div>
                    <div>
                    <img src={lesson.content4Image && lesson.content4Image.url} alt="content 4" />
        
                    <a href={lesson && lesson.contentSubFile4} target='blank'>{lesson && lesson.content4Name} Handouts</a>
                    </div>
                 </div>

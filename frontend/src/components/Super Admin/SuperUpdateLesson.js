...
import { superUpdateLessonAction , lessonDetailsAction } from '../../actions/lessonAction';
...
const SuperUpdateLesson = () => {


  const {error:lessonError,lesson} = useSelector((state) =>state.lessonDetails);
  ...
  const [content4Sub5Image , setContent4Sub5Image]  = useState("/Profile.png")
   ...
   const history = useNavigate();
    ...
    const createLessonSubmitHandler = (e) => {
      ...
      dispatch(superUpdateLessonAction(id,myForm));
  ...
  useEffect(()=>{
    ...
    if (lesson && lesson._id != id) {
      dispatch(lessonDetailsAction(id))
        ...
        setName(lesson.name);
        setAvatarPreview(lesson.avatar.url);
        setVideo1Name(lesson.video1Name);
        setVideo2Name(lesson.video2Name);
        setVideo3Name(lesson.video3Name);
        setVideo4Name(lesson.video4Name);
        setVideo5Name(lesson.video5Name);
        setVideo6Name(lesson.video6Name);
        setVideo1Link(lesson.video1Link);
        setVideo2Link(lesson.video2Link);
        setVideo3Link(lesson.video3Link);
        setVideo4Link(lesson.video4Link);
        setVideo5Link(lesson.video5Link);
        setVideo6Link(lesson.video6Link);
        setGame1Name(lesson.game1Name);
        setGame2Name(lesson.game2Name);
        setGame3Name(lesson.game3Name);
        setGame4Name(lesson.game4Name);
        setGame1Link(lesson.game1Link);
        setGame2Link(lesson.game2Link);
        setGame3Link(lesson.game3Link);
        setGame4Link(lesson.game4Link);
        setContent1Name(lesson.content1Name);
        setContent2Name(lesson.content2Name);
        setContent3Name(lesson.content3Name);
        setContent4Name(lesson.content4Name);
        setContentSub1Name(lesson.contentSub1Name);
        setContent2Sub1Name(lesson.content2Sub1Name);
        setContent3Sub1Name(lesson.content3Sub1Name);
        setContent4Sub1Name(lesson.content4Sub1Name);
        setContentSub2Name(lesson.contentSub2Name);
        setContent2Sub2Name(lesson.content2Sub2Name);
        setContent3Sub2Name(lesson.content3Sub2Name);
        setContent4Sub2Name(lesson.content4Sub2Name);
        setContentSub3Name(lesson.contentSub3Name);
        setContent2Sub3Name(lesson.content2Sub3Name);
        setContent3Sub3Name(lesson.content3Sub3Name);
        setContent4Sub3Name(lesson.content4Sub3Name);
        setContentSub4Name(lesson.contentSub4Name)
        setContent2Sub4Name(lesson.content2Sub4Name)
        setContent3Sub4Name(lesson.content3Sub4Name)
        setContent4Sub4Name(lesson.content4Sub4Name)
        setContentSub5Name(lesson.contentSub5Name);
        setContent2Sub5Name(lesson.content2Sub5Name);
        setContent3Sub5Name(lesson.content3Sub5Name);
        setContent4Sub5Name(lesson.content4Sub5Name);
        setContentSubFile(lesson.contentSubFile);
        setContentSubFile2(lesson.contentSubFile2);
        setContentSubFile3(lesson.contentSubFile3);
        setContentSubFile4(lesson.contentSubFile4);
        setSubContentTime(lesson.subContentTime);
        setSubContentTime2(lesson.subContentTime2);
        setSubContentTime3(lesson.subContentTime3);
        setSubContentTime4(lesson.subContentTime4);
        setSubContentanswerKey(lesson.SubContentanswerKey)
        setSubContentanswerKey2(lesson.SubContentanswerKey2)
        setSubContentanswerKey3(lesson.SubContentanswerKey3)
        setSubContentanswerKey4(lesson.SubContentanswerKey4)
        setSubContentclassRoomLink(lesson.SubContentclassRoomLink);
        setSubContentclassRoomLink2(lesson.SubContentclassRoomLink2);
        setSubContentclassRoomLink3(lesson.SubContentclassRoomLink3);
        setSubContentclassRoomLink4(lesson.SubContentclassRoomLink4);
        setSubContentStandard(lesson.SubContentStandard);
        setSubContentStandard2(lesson.SubContentStandard2);
        setSubContentStandard3(lesson.SubContentStandard3);
        setSubContentStandard4(lesson.SubContentStandard4);

        setAvatar(lesson.avatar);
        setContent1Image(lesson.content1Image);
        setContent2Image(lesson.content2Image);
        setContent3Image(lesson.content3Image);
        setContent4Image(lesson.content4Image);

        setContentSub1Image(lesson.contentSub1Image);
        setContentSub2Image(lesson.contentSub2Image);
        setContentSub3Image(lesson.contentSub3Image);
        setContentSub4Image(lesson.contentSub4Image);
        setContentSub5Image(lesson.contentSub5Image);

        setContent2Sub1Image(lesson.content2Sub1Image);
        setContent2Sub2Image(lesson.content2Sub2Image);
        setContent2Sub3Image(lesson.content2Sub3Image);
        setContent2Sub4Image(lesson.content2Sub4Image);
        setContent2Sub5Image(lesson.content2Sub5Image);

        setContent3Sub1Image(lesson.content3Sub1Image);
        setContent3Sub2Image(lesson.content3Sub2Image);
        setContent3Sub3Image(lesson.content3Sub3Image);
        setContent3Sub4Image(lesson.content3Sub4Image);
        setContent3Sub5Image(lesson.content3Sub5Image);

        setContent4Sub1Image(lesson.content4Sub1Image);
        setContent4Sub2Image(lesson.content4Sub2Image);
        setContent4Sub3Image(lesson.content4Sub3Image);
        setContent4Sub4Image(lesson.content4Sub4Image);
        setContent4Sub5Image(lesson.content4Sub5Image);
  ...
  },[userError,dispatch,alert,error,success,history,lessonError , id , lesson])
  return (
       <Fragment>
        {
          loading ? (<Loader />):(
          ...
          <div className="bannerContainer">
              ...
              <div className="maindashboard">
                ...
                <div className="updatePasswordForm">
                  <h1 className="title">Update Lesson </h1>
...
export default SuperUpdateLesson